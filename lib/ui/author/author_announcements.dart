...
class AuthorAnnouncements extends StatefulWidget {
  @override
  _AuthorAnnouncementsState createState() => _AuthorAnnouncementsState();
}

class _AuthorAnnouncementsState extends State<AuthorAnnouncements> {
  @override
